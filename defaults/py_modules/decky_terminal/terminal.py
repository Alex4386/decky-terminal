...
class Terminal:
    ...
    def __init__(self, cmdline: str, is_shell: bool = True, **kwargs):
        self.cmdline = cmdline  # cmdline can't meaningfully be None or undefined since it must be available for _start_process
    ...
    def get_terminal_env(self):
        result = dict(os.environ)  # dict(os.environ) == dict(**os.environ)
